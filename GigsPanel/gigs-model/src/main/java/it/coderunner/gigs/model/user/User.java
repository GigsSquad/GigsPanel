...
public class User extends BaseEntity<Long>{
	 ...
	 * @param roles
	 * @return zwraca true, jeżeli zbiór ról posiadanych przez użytkownika zmienił się po operacji dodawania.
	 */
	 ...
	 * @param roles
	 * @return zwraca true, jeżeli zbiór ról posiadanych przez użytkownika zmienił się po operacji usuwania.
	 */
	...
	/**
	 * Sprawdza, czy użytkownik posiada wszystkie role zadeklarowane jako parametry metod. 
	 * Jeżeli nie posiada choćby jednej, metoda zwraca false.
	 * @param roles
	 * @return
	 */
